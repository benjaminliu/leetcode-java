...
//        _227_BasicCalculator_II b = new _227_BasicCalculator_II();
//        int calculate = b.calculate("0*0");
//        out.print(calculate);

//        _223_RectangleArea r = new _223_RectangleArea();
//        int i = r.computeArea(-2, -2, 2, 2, 1, 1, 3, 3);
//        out.print(i);

//        _210_CourseSchedule_II c = new _210_CourseSchedule_II();
//        int[] order = c.findOrder(4, new int[][]{{1, 0}, {2, 0}, {3, 1}, {3, 2}});
//        out.print(Arrays.toString(order));

//        _209_MinimumSizeSubarraySum m = new _209_MinimumSizeSubarraySum();
//        int i = m.minSubArrayLen(15, new int[]{5,1,3,5,10,7,4,9,2,8});
//        out.print(i);


//        _179_LargestNumber l = new _179_LargestNumber();
//        String s = l.largestNumber(new int[]{3, 30, 34, 9, 5});
//        out.print(s);
...
//
//        _156_BinaryTreeUpsideDown b = new _156_BinaryTreeUpsideDown();
//        TreeNode treeNode = b.UpsideDownBinaryTree(root);
//        printTreeNodeDFS(treeNode);


//        _153_FindMinimumInRotatedSortedArray f = new _153_FindMinimumInRotatedSortedArray();
//        int min = f.findMin(new int[]{4, 5, 6, 7, 0, 1, 2});
//        out.print(min);

//        _151_ReverseWordsInAString r = new _151_ReverseWordsInAString();
//        String s = r.reverseWords("the sky is blue");
//        out.print(s);

//        _150_EvaluateReversePolishNotation e = new _150_EvaluateReversePolishNotation();
//        int i = e.evalRPN(new String[]{"4", "13", "5", "/", "+"});
//        out.print(i);
...
//
//        _147_InsertionSortList i = new _147_InsertionSortList();
//        ListNode listNode = i.insertionSortList1(head);
...
//        _143_ReorderList r = new _143_ReorderList();
//        r.reorderList(head);
//
//        printListNode(head);
...
//        _127_WordLadder w = new _127_WordLadder();
//        w.ladderLength("hit", "cog", Arrays.asList(new String[]{"hot", "hog", "dog", "lot", "log", "cog"}));
...
//        ll.add(l2);
//
//        int i = t.minimumTotal(ll);
//        out.print(i);

//        TreeNode root = new TreeNode(-2);
//        root.right = new TreeNode(-3);
//        _113_PathSum_II p = new _113_PathSum_II();
//        p.pathSum(root, -2);
...
//
//        _105_ConstructBinaryTreeFromPreorderAndInorderTraversal c =new _105_ConstructBinaryTreeFromPreorderAndInorderTraversal();
//        c.buildTree(new int[]{1,2,4,7,5,8,3,6},new int[]{7,4,2,8,5,1,6,3});
...
//
//        _103_BinaryTreeZigzagLevelOrderTraversal b = new _103_BinaryTreeZigzagLevelOrderTraversal();
//        b.zigzagLevelOrder(root);

//        _95_UniqueBinarySearchTrees_II u = new _95_UniqueBinarySearchTrees_II();
//        List<TreeNode> treeNodes = u.generateTrees(3);
//        for (TreeNode node : treeNodes) {
//            printTreeNodeDFS(node);
//            out.println();
//        }

//        _91_DecodeWays d = new _91_DecodeWays();
//        int i = d.numDecodings("12");
//        out.print(i);
...
//        _86_PartitionList p = new _86_PartitionList();
//        ListNode partition = p.partition(head, 3);
//        printListNode(partition);

//        _82_RemoveDuplicatesFromSortedList_II r = new _82_RemoveDuplicatesFromSortedList_II();
//        ListNode head = new ListNode(1);
//        head.next = new ListNode(1);
//        head.next.next = new ListNode(2);
//        ListNode listNode = r.deleteDuplicates(head);
//        printListNode(listNode);

//        _80_RemoveDuplicatesFromSortedArray_II r = new _80_RemoveDuplicatesFromSortedArray_II();
//        int i = r.removeDuplicates(new int[]{1, 1, 1, 2, 2, 3});
//        out.print(i);
...
//        _74_SearchA2DMatrix s = new _74_SearchA2DMatrix();
//        boolean b = s.searchMatrix(new int[][]{{1, 3, 5, 7}, {10, 11, 16, 20}, {23, 30, 34, 50}}, 30);
//        out.print(b);

//        _71_SimplifyPath s = new _71_SimplifyPath();
//        String s1 = s.simplifyPath("/");
//        out.print(s1);

//        _64_MinimumPathSum m = new _64_MinimumPathSum();
//        int i = m.minPathSum(new int[][]{{1, 2, 5}, {3, 2, 1}});
//        out.print(i);

//        _63_UniquePaths_II u = new _63_UniquePaths_II();
//        int i = u.uniquePathsWithObstacles(new int[][]{{0, 0, 0}, {0, 1, 0}, {0, 0, 0}});
//        out.print(i);

//        _62_UniquePaths u = new _62_UniquePaths();
//        int i = u.uniquePaths(3, 3);
//        out.print(i);
...
//        head.next.next.next = new ListNode(4);
//        head.next.next.next.next = new ListNode(5);
//        _61_RotateList r = new _61_RotateList();
//        ListNode listNode = r.rotateRight(head, 10);
//        printListNode(listNode);

//        _59_SpiralMatrix_II s = new _59_SpiralMatrix_II();
//        int[][] ints = s.generateMatrix(3);
//        for (int[] is : ints) {
//            out.println(Arrays.toString(is));
//        }

//        _55_JumpGame j= new _55_JumpGame();
//        boolean b = j.canJump(new int[]{3, 2, 1, 0, 4});
//        out.print(b);
...
//        _645_SetMismatch s = new _645_SetMismatch();
//        int[] errorNums = s.findErrorNums(new int[]{1, 2, 2, 4});
//        out.print(Arrays.toString(errorNums));


//        _643_MaximumAverageSubarray_I m = new _643_MaximumAverageSubarray_I();
//
//        int[] data = new int[]{6367, 7359, 6636, -7632, -1837, 8671, -120, 5528, -6733, 9942, -1645, 6728, -8842,
//                -3094, -4176, -1847, -7154, 6727, 8100, 3499, -1405, 9549, 2182, -6982, -5991, 8426, 2386, 1766,
//                4634, -3853, 4256, 4317, 3218, 7265, -718, -4970, -7607, -681, -9271, 3802, -4154, 9127, -4683,
//                -9447, 8960, -92, -5367, 5523, 3959, -9499, -3988, 3885, -4833, 1937, 3642, -1247, 8612, -7064,
//                -7463, -160, 5813, 3945, 8240, -7738, 9004, 8126, 5122, -3742, -4623, 8624, 254, 5379, -6462,
//                -2755, 2072, 8906, -474, 4945, 659, -2501, 7944, -569, 8630, 2351, 7266, 7688, -1847, 6691, -912,
//                6486, 7679, -9886, 5018, 3109, 3047, -2827, -8058, 4829, -181, 3910, 5892, 2650, -5304, 6275, 2366,
//                };
//        double maxAverage = m.findMaxAverage(data,
//                10);
//        out.print(maxAverage);


//        _581_ShortestUnsortedContinuousSubarray s = new _581_ShortestUnsortedContinuousSubarray();
//        int unsortedSubarray = s.findUnsortedSubarray(new int[]{1,3,2,2,2});// 6, 4, 8, 10, 9, 15});
//        out.print(unsortedSubarray);


//        TreeNode root = new TreeNode(1);
//        root.left = new TreeNode(1);
//        root.right = new TreeNode(2);
//        _501_FindModeInBinarySearchTree f = new _501_FindModeInBinarySearchTree();
//        int[] mode = f.findMode(root);
//        out.print(Arrays.toString(mode));

//        _438_FindAllAnagramsInAString f = new _438_FindAllAnagramsInAString();
//        List<Integer> anagrams = f.findAnagrams("baa", "aa");
//        out.print(anagrams);
...
//        _437_PathSum_III p = new _437_PathSum_III();
//        p.pathSum(root, 3);

//        _386_LexicographicalNumbers l = new _386_LexicographicalNumbers();
//        List<Integer> list = l.lexicalOrder2(35);

//        _400_NthDigit n = new _400_NthDigit();
//        int nthDigit = n.findNthDigit1(11);
//        out.print(nthDigit);


//        _318_MaximumProductOfWordLengths m = new _318_MaximumProductOfWordLengths();
//        int i = m.maxProduct(new String[]{"abcw", "baz", "foo", "bar", "xtfn", "abcdef"});
//        out.print(i);
...
//        _415_AddStrings a = new _415_AddStrings();
//
...
//        System.out.println(decode);
    ...
    private static void printTreeNodeDFS(TreeNode node) {
        if (null == node) return;
        out.print(node.val);
        if (null != node.left) {
            printTreeNodeDFS(node.left);
        }
        if (null != node.right) {
            printTreeNodeDFS(node.right);
        }
    }
